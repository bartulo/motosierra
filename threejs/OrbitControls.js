...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.keys = { LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40, AUTOROTATE: 82, UPSIDEDOWN: 85, TAPA: 84 };
	...
	$('#texto').text(intersects[0].object.name);        
    }
	...
	function onKeyDown( event ) {
		...
		if ( event.shiftKey && event.ctrlKey ) {
			...
			switch ( event.keyCode ) {
				...
				case scope.keys.TAPA:
					if (tapa[0].visible == true) tapa[0].visible = false;
					else tapa[0].visible = true;
					break;
